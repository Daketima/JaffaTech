...
namespace JaffaTech.Controllers
{
    public class UserRolesController : Controller
    {
        private JaffaTechDbContext db = new JaffaTechDbContext();
        ...
        public ActionResult Create([Bind(Include = "Id,UserId,RoleId")] UserRole userRole)
        {
            ...
            ViewBag.RoleId = new SelectList(db.Role, "Id", "RoleName", userRole.RoleId);
            ViewBag.UserId = new SelectList(db.User, "Id", "Username", userRole.UserId);
            return View(userRole);
        }
